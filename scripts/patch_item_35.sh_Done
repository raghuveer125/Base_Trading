...
cat > "$ROOT/services/execution_service/app/trades.py" <<'PY'
...
cat > "$ROOT/services/execution_service/app/trade_persistence.py" <<'PY'
from __future__ import annotations
